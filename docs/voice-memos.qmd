...
prints the complete copyable command, and offers **Run**, **Print only**, or
**Cancel**. **Help** shows the commands or flags for the current menu level and
then returns there; **Back** moves up one level. Configuration is loaded only
when **Run** is selected. Explicit subcommands remain available for scripts.
...
| Command | Purpose |
|---|---|
| `backup` | Compatibility alias for backing up recordings and summaries |
